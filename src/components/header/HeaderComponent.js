...
function HeaderComponent({loguser}) {
    ...
    let title;
    switch (true) {
        case currentItem === SLUGS.dashboards:
            title = 'Dashboard';
            break;
        case [SLUGS.Product, SLUGS.overviewTwo, SLUGS.overviewThree].includes(currentItem):
            title = 'Overview';
            break;
    ...
    return (
        <Row className={classes.container} vertical='center' horizontal='space-between'>
            ...
            <Row vertical='center'>
                ...
                <div className={classes.iconStyles}>
                    {/* <DropdownComponent
                        label={<IconBell onClick={()=>alert('hello')}  />}
                ...
                <DropdownComponent
                    label={
                        <>
                            <span className={classes.name}>{loguser?.name}</span>
                            {/* <img
